<template>
  <div id="app">
      ...
      <div class="carnet">
        <h3>{{ tituloTarjeta }}</h3>
         <!--require es necesario para cargar la img en vue con rutas relativas-->
        <img width="40" :src="require(`./assets${chip}`)" alt="" />
        <div>
          <h2>{{ numero }}</h2>
        ...
        <footer>
          ...
          <img :src="require(`./assets${tipoTarjeta}`)" width="60" />
        </footer>
      </div>
    </div>
</template>
